exports.up = function(knex, Promise) {
  let createQuery = `INSERT INTO Users (fname, lname, email) VALUES
	...
	INSERT INTO Passengers (uid, rating) VALUES
	(1, 4.5),
	(2, 5.0),
	(5, 3.7),
	(6, 5.0);
	...
	INSERT INTO Drivers (uid, rating, license) VALUES
	(3, 2.0, 'S918841412'),
	(4, 4.5, 'S847189374'),
	(6, 5.0, 'S847876374'),
	(7, 3.8, 'S973654014');
	...
	INSERT INTO SavedDestinations (nickname, address, uid, lat, lng) VALUES
	('tembu', '28 college avenue east', 1, 1.0, 2.0),
	('mbs', 'marina bay sands', 1, 3.0, 4.0),
	('tembu', '28 college avenue east', 2, 5.0, 6.0),
	('tembu', '28 college avenue east', 3, 7.0, 8.0),
	('utown', '8 college avenue east', 4, 9.0, 10.0),
	('tembu', '28 college avenue east', 4, 11.0, 12.0),
	('fatboys', 'clarke quay somewhere', 4, 13.0, 14.0);
